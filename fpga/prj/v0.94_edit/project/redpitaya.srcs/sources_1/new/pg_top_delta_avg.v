...
wire [32-1:0] err_0_avg;
wire [32-1:0] err_1_avg;
wire [32-1:0] err_2_avg;
...
controller_delta_avg pctrl(
    ...
    .err1_o(err_1),
    .err2_o(err_2),
    .err0_avg_o(err_0_avg),
    .err1_avg_o(err_1_avg),
    .err2_avg_o(err_2_avg),
...
begin
	if (rstn_i == 1'b0) begin
		...
		casez (sys_addr[19:0])
			...
			20'h84: begin sys_ack <= sys_en;	sys_rdata <= {{32-1{1'b0}}, delta_finder_rstn}; end
